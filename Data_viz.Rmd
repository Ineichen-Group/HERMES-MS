...
# ggsave("Figure2_final_longnames.svg",figure_panel3,height = 29/2.5,width = 21/2.5)
```
...
# ggsave("Figure6_timeline_final_strip_right.svg",panel_fig_FDA,height = 29/2.7,width = 21/2.7,bg = "white")
...
#EAE_1_drug_mean, EAE_1_drug_n, EAE_1_drug_var, #EAE_1_con_mean, EAE_1_drug_n, EAE_1_drug_var
```
